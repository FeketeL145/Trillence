            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AlbumPhoto = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Length = table.Column<TimeOnly>(type: "time(6)", nullable: false),
                    Listens = table.Column<int>(type: "int", nullable: false),
                    Likes = table.Column<int>(type: "int", nullable: false),
                    Disikes = table.Column<int>(type: "int", nullable: false),
